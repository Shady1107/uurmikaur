        ...
        <div className="divide-y-[0.5px] divide-brand-wine/20 w-full max-w-[100vw]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 hover:bg-brand-cream transition-colors duration-500">
            <div className="lg:col-span-3 p-8 border-r-[0.5px] border-brand-wine/transparent lg:border-brand-wine/20 flex flex-col justify-start border-b-[0.5px] lg:border-b-0 border-brand-wine/20">
              ...
              <img src={imgCouture1} className="w-full max-w-[250px] aspect-[4/5] object-cover mt-8 opacity-90 shadow-sm" alt="Day 1" />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 hover:bg-brand-cream transition-colors duration-500">
            <div className="lg:col-span-3 p-8 border-r-[0.5px] border-brand-wine/transparent lg:border-brand-wine/20 flex flex-col justify-start border-b-[0.5px] lg:border-b-0 border-brand-wine/20">
              ...
              <img src={imgCouture2} className="w-full max-w-[250px] aspect-[4/5] object-cover mt-8 opacity-90 shadow-sm" alt="Day 2" />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 bg-brand-rose/5 hover:bg-brand-cream transition-colors duration-500">
            <div className="lg:col-span-3 p-8 border-r-[0.5px] border-brand-wine/transparent lg:border-brand-wine/20 flex flex-col justify-start border-b-[0.5px] lg:border-b-0 border-brand-wine/20">
              ...
              <img src={imgCouture3} className="w-full max-w-[250px] aspect-[4/5] object-cover mt-8 opacity-90 shadow-sm" alt="Day 3" />
            </div>
            <div className="lg:col-span-9 p-8 flex flex-col justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 hover:bg-brand-cream transition-colors duration-500">
            <div className="lg:col-span-3 p-8 border-r-[0.5px] border-brand-wine/transparent lg:border-brand-wine/20 flex flex-col justify-start border-b-[0.5px] lg:border-b-0 border-brand-wine/20">
              ...
              <img src={imgCouture4} className="w-full max-w-[250px] aspect-[4/5] object-cover mt-8 opacity-90 shadow-sm" alt="Day 4" />
            </div>
            <div className="lg:col-span-9 p-8 flex flex-col justify-center">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-12 hover:bg-brand-cream transition-colors duration-500">
            <div className="lg:col-span-3 p-8 border-r-[0.5px] border-brand-wine/transparent lg:border-brand-wine/20 flex flex-col justify-start border-b-[0.5px] lg:border-b-0 border-brand-wine/20">
              ...
              <img src={imgCouture5} className="w-full max-w-[250px] aspect-[4/5] object-cover mt-8 opacity-90 shadow-sm" alt="Day 5" />
            </div>
             <div className="lg:col-span-9 p-8 flex flex-col justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 bg-white hover:bg-brand-cream transition-colors duration-500">
            <div className="lg:col-span-3 p-8 border-r-[0.5px] border-brand-wine/transparent lg:border-brand-wine/20 flex flex-col justify-start border-b-[0.5px] lg:border-b-0 border-brand-wine/20">
              ...
              <img src={imgCouture6} className="w-full max-w-[250px] aspect-[4/5] object-cover mt-8 opacity-90 shadow-sm" alt="Day 6" />
            </div>
